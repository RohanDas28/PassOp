    ...
    <>
      <header className="text-gray-400 bg-gray-800 body-font">
        <div className="container mx-auto flex flex-wrap p-3 flex-row items-center justify-between">
          <p className="flex title-font font-bold items-center text-green-400 md:mb-0 hover:scale-105 transition ease-in-out cursor-pointer">
            <span className="text-2xl">&lt;<span className="text-white">Pass</span>OP/&gt;</span>
          </p>
          {/* Navigation Section */}
          <nav className="md:ml-auto flex flex-wrap items-center text-base justify-center">
            <a target="_blank" href="https://github.com/RohanDas28/PassOp">
              {/* Github Link Button */}
